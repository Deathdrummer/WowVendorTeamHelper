...
return [
	...
	'custom'               => [
		...
		'command_id' => [
            'required' => 'Необходимо выбрать команду!',
            'numeric' => 'Необходимо выбрать команду!',
        ],
		'event_type_id' => [
			'required' => 'Необходимо выбрать тип события!',
			'numeric' => 'Необходимо выбрать тип события!',
		],
		'date' => [
			'required' => 'Необходимо зполнить дату!',
