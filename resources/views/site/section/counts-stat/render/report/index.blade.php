<x-horisontal space="2rem" ignore="[noscroll], select, input, textarea" ignoremovekeys="alt, ctrl, shift" style="max-width: calc(100vw - 320px);">
	<x-horisontal.item class="h100">
		<x-table class="w100" scrolled="calc(100vh - 162px)">
			<x-table.head>
