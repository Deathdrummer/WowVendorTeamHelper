			...
			<div class="ddrtabs__content ddrtabscontent" ddrtabscontent>
				...
				<div class="ddrtabscontent__item" ddrtabscontentitem="sectionsTab5">
					...
					<x-simplelist
						...
						fieldset="ID:w6rem|number|id|1,Название уведомеления:w20rem|text|title,Цвет кнопки:w20rem|select|color,Иконка:w15rem|text|icon,Тайаут (сек):w7rem|number|timeout,Вебхук:w30rem|textarea|webhook,Сообщение:w30rem|textarea|message,Право:w15rem|text|permission"
